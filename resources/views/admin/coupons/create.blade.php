            ...
            <form action="{{ route('admin.coupons.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" placeholder="e.g., SAVE20" class="w-full px-4 py-2 border border-gray-300 rounded-lg uppercase @error('code') border-red-500 @enderror" required>
                            @error('code') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            <p class="text-xs text-gray-500 mt-1">Code will be stored in uppercase</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                            <textarea name="description" rows="3" placeholder="What is this coupon for?" class="w-full px-4 py-2 border border-gray-300 rounded-lg @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="discount_value" value="{{ old('discount_value') }}" step="0.01" min="0" placeholder="e.g., 20" class="w-full px-4 py-2 border border-gray-300 rounded-lg @error('discount_value') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="minimum_amount" value="{{ old('minimum_amount', 0) }}" step="0.01" min="0" placeholder="₹0 (no minimum)" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="max_uses" value="{{ old('max_uses') }}" min="1" placeholder="e.g., 100" class="w-full px-4 py-2 border border-gray-300 rounded-lg @error('max_uses') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="uses_per_user" value="{{ old('uses_per_user', 1) }}" min="1" placeholder="e.g., 1" class="w-full px-4 py-2 border border-gray-300 rounded-lg @error('uses_per_user') border-red-500 @enderror">
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="expires_at" value="{{ old('expires_at') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg @error('expires_at') border-red-500 @enderror">
                ...
                <div class="border-t border-gray-200 pt-6 flex gap-3">
                    <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Coupon</button>
